 ...
 * It handles the drivers' access to the parent lib
 *
 * @package		CodeIgniter
 * @subpackage	Libraries
 * @category	Libraries
...
class CI_Driver {
	 ...
	 * __call magic method
	 *
	 * Handles access to the parent driver lib's methods
	 *
	 * @access	public
	 * @param	string
	 * @param	array
	 ...
	 * __get magic method
	 *
	 * Handles reading of the parent driver lib's properties
	 *
	 * @param	string
	 * @return	mixed
	 */
	 ...
	 * __set magic method
	 *
	 * Handles writing to the parent driver lib's properties
	 *
	 * @param	string
	 * @param	array
	 * @return	mixed
