...
class Captcha {
     ...
     *
     */
    public $resourcesPath = 'resources/public';
     ...
     */
    public $fonts = array(
        'Antykwa' => array('spacing' => -2, 'minSize' => 20, 'maxSize' => 22, 'font' => 'AntykwaBold.ttf'),
        'Candice' => array('spacing' => -1, 'minSize' => 20, 'maxSize' => 24, 'font' => 'Candice.ttf'),
        'DingDong' => array('spacing' => -1, 'minSize' => 20, 'maxSize' => 22, 'font' => 'Ding-DongDaddyO.ttf'),
        'Duality' => array('spacing' => -1, 'minSize' => 20, 'maxSize' => 24, 'font' => 'Duality.ttf'),
        'Heineken' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 20, 'font' => 'Heineken.ttf'),
        'Jura' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 20, 'font' => 'Jura.ttf'),
        'StayPuft' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 24, 'font' => 'StayPuft.ttf'),
        'Times' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 22, 'font' => 'TimesNewRomanBold.ttf'),
        'VeraSans' => array('spacing' => -1, 'minSize' => 16, 'maxSize' => 20, 'font' => 'VeraSansBold.ttf'),
    );
    ...
    public function CreateChineseImage($text = '') {
        //生成验证码
        ...
        $fontfile = "resources/public/font/STXINGKA.TTF";
        ...
        if (empty($text)) {
            $CI = &get_instance();
            $CI->load->config('public/captcha');
            $ChineseChar = CaptchaConfig::$chinese_word;
            $len = count($ChineseChar) - 1;
            for ($i = 1; $i <= 4; $i++) {
                $r = rand(1, $len);
                $text .= $ChineseChar[$r];
            }
        ...
        ImageTTFText($authimg, 20, 0, 16, 30, $font_color, $fontfile, $text);
        ImagePNG($authimg);
        ImageDestroy($authimg);
    }

    public function GetChineseCaptchaText() {
        $text = '';
        $CI = &get_instance();
        $CI->load->config('public/captcha');
        $ChineseChar = CaptchaConfig::$chinese_word;
     ...
     * @return string Text
     */
    public function GetRandomCaptchaText($length = null) {
        if (empty($length)) {
