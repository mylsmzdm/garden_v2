...
class PHPExcel_Settings
{
    ...
    /**
     * Set details of the external lib that PHPExcel should use for rendering charts
     *
     * @param string $libraryName	Internal reference name of the lib
     *	e.g. PHPExcel_Settings::CHART_RENDERER_JPGRAPH
     * @param string $libraryBaseDir Directory path to the lib's base folder
     *
     * @return	boolean	Success or failure
     */
    ...
    /**
     * Identify to PHPExcel the external lib to use for rendering charts
     *
     * @param string $libraryName	Internal reference name of the lib
     *	e.g. PHPExcel_Settings::CHART_RENDERER_JPGRAPH
     *
    ...
    /**
     * Tell PHPExcel where to find the external lib to use for rendering charts
     *
     * @param string $libraryBaseDir	Directory path to the lib's base folder
     * @return	boolean	Success or failure
     */
    ...
    /**
     * Set details of the external lib that PHPExcel should use for rendering PDF files
     *
     * @param string $libraryName Internal reference name of the lib
    ...
    /**
     * Identify to PHPExcel the external lib to use for rendering PDF files
     *
     * @param string $libraryName Internal reference name of the lib
     * 	e.g. PHPExcel_Settings::PDF_RENDERER_TCPDF,
     *	PHPExcel_Settings::PDF_RENDERER_DOMPDF
    ...
    /**
     * Tell PHPExcel where to find the external lib to use for rendering PDF files
     *
     * @param string $libraryBaseDir Directory path to the lib's base folder
     * @return boolean Success or failure
     */
