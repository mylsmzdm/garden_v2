<?php
/**
 * ZHIMA API: zhima.credit.watchlist.summary.get request
 *
 * @author auto create
 * @since 1.0, 2016-01-20 12:04:11
 */
class ZhimaCreditWatchlistSummaryGetRequest
{
	/** 
	 * 身份证号
	 **/
	...
	{
		return "zhima.credit.watchlist.summary.get";
	}
