...
class CI_Javascript {
	...
	public function __construct($params = array())
	{
		...
		// load the requested js lib
		$this->CI->load->library('javascript/'.$js_library_driver, array('autoload' => $autoload));
		// make js to refer to current lib
	 ...
	 * Blur
	 *
	 * Outputs a javascript lib blur event
	 *
	 * @access	public
	 ...
	 * Change
	 *
	 * Outputs a javascript lib change event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Click
	 *
	 * Outputs a javascript lib click event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Double Click
	 *
	 * Outputs a javascript lib dblclick event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Error
	 *
	 * Outputs a javascript lib error event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Focus
	 *
	 * Outputs a javascript lib focus event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Hover
	 *
	 * Outputs a javascript lib hover event
	 *
	 * @access	public
	 ...
	 * Keydown
	 *
	 * Outputs a javascript lib keydown event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Load
	 *
	 * Outputs a javascript lib load event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mousedown
	 *
	 * Outputs a javascript lib mousedown event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouse Out
	 *
	 * Outputs a javascript lib mouseout event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouse Over
	 *
	 * Outputs a javascript lib mouseover event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Mouseup
	 *
	 * Outputs a javascript lib mouseup event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Resize
	 *
	 * Outputs a javascript lib resize event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Scroll
	 *
	 * Outputs a javascript lib scroll event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Unload
	 *
	 * Outputs a javascript lib unload event
	 *
	 * @access	public
	 * @param	string	The element to attach the event to
	 * @param	string	The code to execute
	 ...
	 * Add Class
	 *
	 * Outputs a javascript lib addClass event
	 *
	 * @access	public
	 * @param	string	- element
	 ...
	 * Animate
	 *
	 * Outputs a javascript lib animate event
	 *
	 * @access	public
	 * @param	string	- element
	 ...
	 * Fade In
	 *
	 * Outputs a javascript lib hide event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Slide Up
	 *
	 * Outputs a javascript lib slideUp event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Remove Class
	 *
	 * Outputs a javascript lib removeClass event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- Class to add
	 ...
	 * Slide Down
	 *
	 * Outputs a javascript lib slideDown event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Slide Toggle
	 *
	 * Outputs a javascript lib slideToggle event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Hide
	 *
	 * Outputs a javascript lib hide action
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
	 ...
	 * Toggle
	 *
	 * Outputs a javascript lib toggle event
	 *
	 * @access	public
	 * @param	string	- element
	 * @return	string
	 ...
	 * Toggle Class
	 *
	 * Outputs a javascript lib toggle class event
	 *
	 * @access	public
	 * @param	string	- element
	 * @return	string
	 ...
	 * Show
	 *
	 * Outputs a javascript lib show event
	 *
	 * @access	public
	 * @param	string	- element
	 * @param	string	- One of 'slow', 'normal', 'fast', or time in milliseconds
